                ...
                defaultCmds.image._dropDown(
                    ...
                    function (url, width$$1, height$$1) {
                        ...
                        if (url && url.match(/\{(.*.)\}/ig)) {
                            ...
                            _wysiwygText = '<img' + attrs + ' src="' + url + '" />';
                        }

                        console.log('_wysiwygText ', _wysiwygText)
    ...
    var bbcodeHandlers = {
        ...
        img: {
            ...
            html: function (token, attrs, content) {
                ...
                // console.log('test...')
                //Small hack to fix image for template

                console.log('')
                console.log('test 2 attrs ', attrs);
                console.log('')

                if (content && content.match(/{.*?}/i)) {
                
                    if (attrs.defaultattr) {
                        // return '[img=' + attrs.defaultattr + ']' + content + '[/img]';
                        return  content + '(' + attrs.defaultattr + ')';
                    } else if (attrs.width || attrs.height) {
                        // return '[img ' + (attrs.width ? ' width='+attrs.width : '')+ (attrs.height ? ' height='+attrs.height : '') + ']' + content + '[/img]';
                        return content + '(' + (attrs.width ? ' width=' + attrs.width : '') + (attrs.height ? ' height=' + attrs.height : '') + ')';
                    } else {
