...
var fileUpload = function (job, io) {
    ...
    this.uploadInfo = "https://turbobit.net/v001/upload/http/server";

    this.server = 'turbobit.net';
    this.host = 'turbobit.net';
    ...
    return new Promise(function (resolve, reject) {
        ...
        request(opts, function (err, response, body) {
            ...
            try {
                ...
                var _url = body['url'];
                var _apptype = body['params']['apptype'];
                var _upload_info = body['params']['upload_info'];
                ...
                if (result != true) {
                    ...
                    _this.upload_info = _upload_info;
                    return resolve();
                }
...
fileUpload.prototype.send = function () {
    ...
    return new Promise(function (resolve, reject) {
        ...
        if (!_this.upload_info) return reject("*Please verify Upload UUID, it's missing.");
            ...
            response.on('data', function (data) {
                ...
                if (!data) {
                    ...
                    if (data && data['result'] != true) {
                        ...
                        _this.link = `https://turbobit.net/${_id}.html`;
                        return resolve();
                    }
                }
            })
        ...
        var form = r.form();
        form.append('apptype', _this.apptype);
        form.append('upload_info', _this.upload_info);
