...
var fileUpload = function (job, io) {
    ...
    this.uploadInfo = "https://api.verystream.com/file/ul";

    this.server = 'verystream.com';
    this.host = 'verystream.com';
...
fileUpload.prototype._getServer = function () {
    ...
    return new Promise(function (resolve, reject) {
        ...
        _this.uploadInfo = `${_this.uploadInfo}?login=${_this._api_id}&key=${_this._api_key}&sha1=${_this.SHA1}`;
...
fileUpload.prototype.datainit = function () {
    ...
    return new Promise(function (resolve, reject) {
        Hosts.findOne({
            ...
            _this._api_id = result.api_id;
            _this._api_key = result.api_key;

            if (result.use_account == false || !_this._api_id || !_this._api_key) {
