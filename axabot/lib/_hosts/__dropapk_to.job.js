...
var fileUpload = function (job, io) {
    ...
    this._server = "https://dropapk.to/api/upload/server";

    this.server = 'dropapk.to';
    this.host = 'dropapk.to';
    ...
    return new Promise(function (resolve, reject) {
        ...
        request(opts, function (err, response, body) {
            ...
            try {
                ...
                var _sess_id = body['sess_id'];

                if (!_url || _status != 200 || !_sess_id) {
            ...
            response.on('data', function (data) {
                ...
                try {
                    ...
                    if (!_id || _id == "") {
                        ...
                        _this.link = `https://dropapk.to/${_id}`;
                        return resolve();
                    }
                } catch (e) {
